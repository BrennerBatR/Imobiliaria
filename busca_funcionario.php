...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="_css/busca_funcionario.css" />
    <script src="_javascript/js_busca.js"></script>
...
<div class="pesquisa">
    ...
    <form onsubmit="return verificabusca(this)" class="busca" action="_php/busca.php" method="POST">
        <div id="parte1">
            <h2>ID imóvel</h2>
            <input id="id_imovel" onpaste="return false" ondrop="return false" type="text" name="id_imovel" placeholder="ID imóvel" onkeypress="return SomenteNumeros(this)">
            <br>
            <h2>Transação:<span>*</span></h2>
            <input id="venda" onclick="preco_nome()" type="radio" name="transacao" value="">
            <label for="venda">Venda</label>
            <br>
            <input id="locacao" onclick="preco_nome()" type="radio" name="transacao" value="">
        ...
        <div id="parte2">
            <h2>Situação</h2>
            <input id="disponivel" type="radio" name="situacao" value="1">
            <label for="disponivel">Disponivel</label>
            <br>
            <input id="alugado" type="radio" name="situacao" value="2">
            <label for="alugado">Alugado</label>
            <br>
            <input id="vendido" type="radio" name="situacao" value="3">
            <label for="vendido">Vendido</label>
            <br>
            <input id="reforma" type="radio" name="situacao" value="4">
            <label for="reforma">Em reforma</label>
            <br>
            <h2>Preço:</h2>
            <input id="preco" name="preco" type="range" oninput="mostrarPreco(this.value)" min="100" value="2000" max="10000" step="100"
            />
            <h3>Abaixo de:</h3>
            <p> &nbsp;&nbsp;R$
                <span id="exibe_preco">2000</span>
                <font>,00</font>
            </p>
            <input onclick="preco_nome()" id="qualquer_preco" type="radio" name="qualquer_preco" value=''>
            <label for="qualquer_preco">Qualquer valor</label>
            <br>
        </div>
        ...
        <div id="parte3">
            ...
            <select id="cidades" name="cidades">
                ...
                <option value="Joao Molevade">João Molevade</option>
            </select>
            <h3>Bairro:</h3>
            ...
            <h3>CEP:</h3>
            <input id="cep" onpaste="return false" ondrop="return false" type="text" name="cep" placeholder="00.000-000" onkeypress="return TratarCep(event,this,'##.###-###')" maxlength="10"
            />
        ...
        <input id="concluir" type="submit" name="buscar" value="Busca">
    </form>
</div>
